...
RDEPENDS_${PN}_append_oxygen = " ${LIBHYBRIS_RDEPENDS} ${MEMNOTIFY_RDEPENDS}"
...
RDEPENDS_${PN}_append_s2 = " ${LIBHYBRIS_RDEPENDS} ${MEMNOTIFY_RDEPENDS}"
RDEPENDS_${PN}_append_sagit = " ${LIBHYBRIS_RDEPENDS} ${MEMNOTIFY_RDEPENDS} bluebinder"
RDEPENDS_${PN}_append_yggdrasil = " ${LIBHYBRIS_RDEPENDS} ${MEMNOTIFY_RDEPENDS} bluebinder"
